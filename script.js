...
Response: "Wah, bhai, tu theek hai toh dil khush ho gaya! Main bhi theek hoon, shukriya! Ab koi mazedaar sawal poochh, ya kuch aur baat karna hai?"`
    ...
    function startNewChat() {
        ...
        chats[newChatId] = {
            ...
            messages: [{
                role: "model",
                parts: [{ text: "Hello! I am Unas AI. How can I assist you today?" }]
            }]
        };
    ...
    function renderChat(chatId) {
        ...
        chats[chatId].messages.forEach(msg => addMessageToUI(msg.parts[0].text, msg.role === 'user' ? 'user' : 'bot'));
    ...
    async function handleFormSubmit(e) {
        ...
        if (chats[activeChatId].messages.length === 2) {
            chats[activeChatId].title = userMessageText.substring(0, 30) + '...';
            renderHistory();
            chatTitleHeader.textContent = chats[activeChatId].title;
        }
